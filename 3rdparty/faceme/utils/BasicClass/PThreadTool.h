...
public:
    ...
    int CreateThreadRun(ThreadFunctionReturnType (*start_routine)(void *), void *argument);
    int CreateThread_Run(ThreadFunctionReturnType (*start_routine)(void *), void *argument)
    { 
